...
namespace TechJobsConsole
{
    class Program
    {
        ...
        public static StringBuilder DisplayResults(StringBuilder myString, int Length)
        {
            ...
            {
                return DisplayResults(myString.Append(" "), Length);
            }
        }
            ...
            { 
                foreach (Dictionary<string, string> job in someJobs)
                {
                    ...
                    foreach (string key in job.Keys)
                    {
                        ...
                        keyBuilder = DisplayResults(keyBuilder, 15);
